...
```{r}
incident_counts = readr::read_csv(here::here("2023-08_lab-leaks/lab-accidents.csv"), show_col_types = FALSE) |>
...
lab_counts = readr::read_csv(here::here("2023-08_lab-leaks/bsl4.csv"), show_col_types = FALSE) |>
    ...
    filter(!is.na(n))
web_of_science_counts = readr::read_tsv(here::here("2023-08_lab-leaks/web-of-science.tsv")) |>
